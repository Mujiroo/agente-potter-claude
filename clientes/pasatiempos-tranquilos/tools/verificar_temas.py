...
BAD_RELLENO = (
    # sexuales y genitales (varios países)
    "PICO PICHA PICHULA PIJA PINGA POLLA VERGA PENE CHOTA CHOTO CHOCHO CHOCHA CONCHA CHUCHA CUCA TOTA TOTO PAPO "
    "BICHO CHIMBA CHIMBO CHORO CULO CULITO OJETE ORTO POTO NALGA TETA TETON SEXO SEXY COGER COJER FOLLAR FOLLA "
    "CULEAR CACHAR MAMAR MAMADA PAJA PAJERO PUÑETA "
    # insultos
    "PUTA PUTO PUTON PERRA ZORRA GUARRA FURCIA RAMERA CABRON CORNUDO CARAJO COÑO JODER JODIDO CHINGA PINCHE "
    "PENDEJ BOLUDO PELOTUDO HUEVON WEON GUEON COJON MARICA MARICON JOTO CULERO CULIAO CULIADO MAMON TARADO "
    "IDIOTA IMBECIL ESTUPID CRETINO RETRASAD MONGOL INUTIL TONTO TONTA BOBO BOBA SUDACA "
    # escatológicas y de mal gusto
    "MIERDA CAGAR CAGADA CAGON CACA MEAR MEADO PEDO PEDORR MOCO VOMITO "
    # violencia y drogas
    "MATAR SUICID DROGA PORRO NAZI"
).split()
