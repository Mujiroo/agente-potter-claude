...
- 18-sep 10:00 2.º recordatorio enviado a Pedro: revisar «En venta» y subir precio 7,99 → 12,99. Cron borrado.
- 18-sep 20:36 Captura de Pedro (msg 1161): Calm & Cozy tapa blanda «En línea», US$ 7,99, ASIN B0HK9QSXDD (enviado 18-sep). Le di los pasos para subir a 12,99. Pendiente de interior para una edición: pág. de gracias repetitiva y relleno con filtro ES ampliado (ver memory/proyectos.md).
- 18-sep 20:4x Edición 2 del interior (msg 1164: «hacemos eso?»): pág. 122 reescrita («We are so glad you chose…», sin repetir thank/helps) y relleno regenerado con filtro ampliado ES (generar_mixto/verificar_mixto ahora suman BAD_ES + BAD_RELLENO). `entregables/vol1_edicion2/`: 122 págs., verificar_mixto 0/0, márgenes OK, 0 Type3. Cambian 46 páginas de sopas (grillas) + la 122; sudokus, laberintos y textos iguales. Portada igual.
  - Pedro ya subió el precio a 12,99 (msg 1166) → el libro queda en revisión; subir este manuscrito cuando vuelva a «En línea». Recordatorio agregado al cron del 21-sep 12:45.
