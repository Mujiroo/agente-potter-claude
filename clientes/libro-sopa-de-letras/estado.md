...
- 18-sep 10:5x Barrido de libros en inglés (msg 1042): 0 groserías en inglés; con filtro ES ampliado hay hallazgos en los 6 (Calm & Cozy: PAJA, WEON, MOCO; Vol.1 TETA ORTO CACA PAPO; Vol.2 TETA PEDO TOTA; Vol.3 PENE PAJA WEON MEAR TOTO; Vol.4 TETA TOTA PAPO MOCO TONTO BOBO; Vol.5 PENE ORTO TOTO). Recomendé regenerar los no subidos y actualizar Calm & Cozy / Memory Lane cuando estén En venta. Esperando qué Word Search ya subió.
- 18-sep 10:56 Pedro: dejarlo guardado y regenerar cada libro al momento de editarlo (msg 1047). Anotado en memory/proyectos.md.
- 18-sep 11:15 Revisión final de los 3 libros en revisión KDP (msg 1061), sobre los PDF finales (pdfjs + tools/auditar_pdf.py):
  - OK: Vol. 4 y Vol. 5 55/55 sin errores; Calm & Cozy regenerado = PDF subido (texto idéntico), verificar_mixto 0/0. MediaBox, lomo, fuentes, 0 Type3 y márgenes OK.
